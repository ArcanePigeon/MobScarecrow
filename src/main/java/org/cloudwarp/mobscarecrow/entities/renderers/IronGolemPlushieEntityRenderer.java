...
import org.cloudwarp.mobscarecrow.models.IronGolemPlushieModel;
import org.jetbrains.annotations.Nullable;

public class IronGolemPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, IronGolemPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/iron_golem_plushie.png");

	public IronGolemPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new IronGolemPlushieModel(context.getPart(IronGolemPlushieModel.LAYER_LOCATION)), 0.3f);
	}
