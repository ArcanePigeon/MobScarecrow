...
import org.cloudwarp.mobscarecrow.models.PigeonPlushieModel;
import org.jetbrains.annotations.Nullable;

public class PigeonPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, PigeonPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/pigeon_plushie.png");

	public PigeonPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new PigeonPlushieModel(context.getPart(PigeonPlushieModel.LAYER_LOCATION)), 0.3f);
	}
