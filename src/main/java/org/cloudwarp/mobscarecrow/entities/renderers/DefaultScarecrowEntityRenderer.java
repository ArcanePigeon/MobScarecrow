...
import org.cloudwarp.mobscarecrow.models.DefaultScarecrowModel;
import org.jetbrains.annotations.Nullable;

public class DefaultScarecrowEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, DefaultScarecrowModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/default_scarecrow.png");

	public DefaultScarecrowEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new DefaultScarecrowModel(context.getPart(DefaultScarecrowModel.LAYER_LOCATION)), 0.3f);
	}
