...
import org.cloudwarp.mobscarecrow.models.ZombifiedPiglinPlushieModel;
import org.jetbrains.annotations.Nullable;

public class ZombifiedPiglinPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, ZombifiedPiglinPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/zombified_piglin_plushie.png");

	public ZombifiedPiglinPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new ZombifiedPiglinPlushieModel(context.getPart(ZombifiedPiglinPlushieModel.LAYER_LOCATION)), 0.3f);
	}
