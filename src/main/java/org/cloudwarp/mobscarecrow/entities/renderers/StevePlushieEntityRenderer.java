...
public class StevePlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, StevePlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/steve_plushie.png");

	public StevePlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new StevePlushieModel(context.getPart(StevePlushieModel.LAYER_LOCATION)), 0.3f);
	}
