...
import org.cloudwarp.mobscarecrow.models.WolfPlushieModel;
import org.jetbrains.annotations.Nullable;

public class WolfPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, WolfPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/wolf_plushie.png");

	public WolfPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new WolfPlushieModel(context.getPart(WolfPlushieModel.LAYER_LOCATION)), 0.3f);
	}
