...
import org.cloudwarp.mobscarecrow.models.VillagerPlushieModel;
import org.jetbrains.annotations.Nullable;

public class VillagerPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, VillagerPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/villager_plushie.png");

	public VillagerPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new VillagerPlushieModel(context.getPart(VillagerPlushieModel.LAYER_LOCATION)), 0.3f);
	}
