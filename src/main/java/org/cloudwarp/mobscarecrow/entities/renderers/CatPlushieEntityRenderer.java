...
import org.cloudwarp.mobscarecrow.models.CatPlushieModel;
import org.jetbrains.annotations.Nullable;

public class CatPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, CatPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/cat_plushie.png");

	public CatPlushieEntityRenderer(EntityRendererFactory.Context context) {
		//super(context, new CatPlushieModel(context.getPart(MSEntityModelLayers.CAT_PLUSHIE)), 0.0f);
		super(context, new CatPlushieModel(context.getPart(CatPlushieModel.LAYER_LOCATION)), 0.3f);
	}
