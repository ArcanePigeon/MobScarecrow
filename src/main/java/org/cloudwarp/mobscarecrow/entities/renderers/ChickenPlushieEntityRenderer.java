...
import org.cloudwarp.mobscarecrow.models.ChickenPlushieModel;
import org.jetbrains.annotations.Nullable;

public class ChickenPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, ChickenPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/chicken_plushie.png");

	public ChickenPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new ChickenPlushieModel(context.getPart(ChickenPlushieModel.LAYER_LOCATION)), 0.3f);
	}
