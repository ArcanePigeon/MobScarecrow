...
import org.cloudwarp.mobscarecrow.models.ZombiePlushieModel;
import org.jetbrains.annotations.Nullable;

public class ZombiePlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, ZombiePlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/zombie_plushie.png");

	public ZombiePlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new ZombiePlushieModel(context.getPart(ZombiePlushieModel.LAYER_LOCATION)), 0.3f);
	}
