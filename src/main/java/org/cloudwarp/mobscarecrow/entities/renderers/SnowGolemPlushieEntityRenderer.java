...
import org.cloudwarp.mobscarecrow.models.SnowGolemPlushieModel;
import org.jetbrains.annotations.Nullable;

public class SnowGolemPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, SnowGolemPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/snow_golem_plushie.png");

	public SnowGolemPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new SnowGolemPlushieModel(context.getPart(SnowGolemPlushieModel.LAYER_LOCATION)), 0.3f);
	}
