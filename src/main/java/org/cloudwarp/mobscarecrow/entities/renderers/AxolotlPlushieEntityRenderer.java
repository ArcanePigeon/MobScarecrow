...
import org.cloudwarp.mobscarecrow.models.AxolotlPlushieModel;
import org.jetbrains.annotations.Nullable;

public class AxolotlPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, AxolotlPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/axolotl_plushie.png");

	public AxolotlPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new AxolotlPlushieModel(context.getPart(AxolotlPlushieModel.LAYER_LOCATION)), 0.3f);
	}
	...
	protected RenderLayer getRenderLayer(SmallPlushieEntity smallPlushieEntity, boolean bl, boolean bl2, boolean bl3) {
		...
		if (bl2) {
			return RenderLayer.getEntityCutoutNoCullZOffset(identifier, false);
