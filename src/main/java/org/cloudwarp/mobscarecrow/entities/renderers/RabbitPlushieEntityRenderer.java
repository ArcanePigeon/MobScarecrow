...
import org.cloudwarp.mobscarecrow.models.RabbitPlushieModel;
import org.jetbrains.annotations.Nullable;

public class RabbitPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, RabbitPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/rabbit_plushie.png");

	public RabbitPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new RabbitPlushieModel(context.getPart(RabbitPlushieModel.LAYER_LOCATION)), 0.3f);
	}
