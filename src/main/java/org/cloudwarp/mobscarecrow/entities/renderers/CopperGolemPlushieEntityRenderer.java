...
import org.cloudwarp.mobscarecrow.models.CopperGolemPlushieModel;
import org.jetbrains.annotations.Nullable;

public class CopperGolemPlushieEntityRenderer extends LivingEntityRenderer<SmallPlushieEntity, CopperGolemPlushieModel> {
	public static final Identifier TEXTURE = MobScarecrow.id("textures/entity/copper_golem_plushie.png");

	public CopperGolemPlushieEntityRenderer (EntityRendererFactory.Context context) {
		super(context, new CopperGolemPlushieModel(context.getPart(CopperGolemPlushieModel.LAYER_LOCATION)), 0.3f);
	}
