...
public class Config {
	...
	public double getScarerowDistance () {
		return configData.getDouble("scarecrow_distance");
	}
	...
	private NbtCompound getDefaults () {
		...
		defaultConfig.putDouble("scarecrow_distance", 8D);
	...
	private JsonObject toJson (NbtCompound tag) {
		...
		json.addProperty("scarecrow_distance", getDoubleOrDefault(tag, "scarecrow_distance", defaults));
	...
	private NbtCompound toNbtCompound (JsonObject json) {
		...
		tag.putDouble("scarecrow_distance", getDoubleOrDefault(json, "scarecrow_distance", defaults));
