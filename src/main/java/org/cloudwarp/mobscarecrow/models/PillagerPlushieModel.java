...
public class PillagerPlushieModel extends EntityModel<SmallPlushieEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(MobScarecrow.id("pillager_plushie"), "main");
	private final ModelPart Plushie;

	public PillagerPlushieModel (ModelPart root) {
		this.Plushie = root.getChild("pillager_plushie");
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Plushie = ModelPartData.addChild("pillager_plushie", ModelPartBuilder.create().uv(21, 14).cuboid(-3.0F, 2.0F, 0.0F, 6.0F, 6.0F, 3.0F, new Dilation(-0.1F)), ModelTransform.pivot(0.0F, 16.0F, 0.0F));
		...
		Plushie.addChild("cube_r2", ModelPartBuilder.create().uv(16, 24).mirrored().cuboid(0.25F, 0.0F, -5.0F, 3.0F, 3.0F, 5.0F, new Dilation(0.0F)).mirrored(false)
				.uv(16, 24).cuboid(-3.25F, 0.0F, -5.0F, 3.0F, 3.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		Plushie.addChild("cube_r3", ModelPartBuilder.create().uv(19, 0).cuboid(-1.0F, -3.0F, -3.75F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F))
