...
public class ZombiePlushieModel extends EntityModel<SmallPlushieEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(MobScarecrow.id("zombie_plushie"), "main");
	private final ModelPart Plushie;

	public ZombiePlushieModel (ModelPart root) {
		this.Plushie = root.getChild("zombie_plushie");
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Plushie = ModelPartData.addChild("zombie_plushie", ModelPartBuilder.create().uv(21, 13).cuboid(-3.0F, 2.0F, 0.0F, 6.0F, 6.0F, 3.0F, new Dilation(-0.1F)), ModelTransform.pivot(0.0F, 16.0F, 0.0F));
