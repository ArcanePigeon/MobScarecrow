...
public class ScarecrowItem extends Item {
	...
	public ScarecrowItem(Item.Settings settings, MSEntityTypes scarecrowType) {
		super(settings);
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world instanceof ServerWorld) {
			...
			world.emitGameEvent((Entity)context.getPlayer(), GameEvent.ENTITY_PLACE, scarecrowEntity);
		}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		if(Screen.hasShiftDown()){
			tooltip.add(new TranslatableText("item.mobscarecrow."+ scarecrowType.id +".tooltip.shift"));
		}else{
			tooltip.add(new TranslatableText("item.mobscarecrow.generic_scarecrow.tooltip"));
		}
	}
}
